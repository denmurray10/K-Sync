...
class SeoRolloutTests(TestCase):
    ...
    def test_member_profile_and_birthday_pages_render(self):
        ...
        self.assertContains(profile_response, 'Biography')
        self.assertContains(profile_response, 'Broadcast Performance Stats')
        self.assertContains(profile_response, 'Discography')
        self.assertContains(profile_response, 'Track Radar')
        self.assertContains(profile_response, 'Milestone Signals')
